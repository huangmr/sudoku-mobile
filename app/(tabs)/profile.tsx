        ...
        <View style={s.card}>
          {isLoggedIn ? (
            ...
            <>
              ...
              >
                Sign in to save progress, earn rewards, and climb the
                leaderboard.
              </Text>
          ...
          {THEME_OPTIONS.map((opt) => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  borderColor:
                    preference === opt.value ? colors.primary : colors.border,
                  backgroundColor:
                    preference === opt.value ? colors.primary : "transparent",
                },
              ]}
            ...
            >
              <Text
                style={{
                  color:
                    preference === opt.value ? "#fff" : colors.textSecondary,
                  fontWeight: "600",
                }}
              >
                {opt.label}
      ...
      {isLoggedIn && (
        <View style={s.section}>
          ...
          <TouchableOpacity
            ...
            onPress={logout}
          >
            <Text style={{ color: "#ef5350", fontSize: 15, fontWeight: "600" }}>
              Logout
            </Text>
          </TouchableOpacity>
        </View>
