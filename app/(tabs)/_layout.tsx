...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="game"        options={{ title: 'Play',         tabBarIcon: ({ color }) => <TabIcon icon="🎮" color={color} /> }} />
      <Tabs.Screen name="leaderboard" options={{ title: 'Leaderboard',  tabBarIcon: ({ color }) => <TabIcon icon="🏆" color={color} /> }} />
      <Tabs.Screen name="rewards"     options={{ title: 'Rewards',      tabBarIcon: ({ color }) => <TabIcon icon="💎" color={color} /> }} />
